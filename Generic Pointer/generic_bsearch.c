 ...
 *         int (*cmpfn)(const void* vp1, const void* vp2), callback funtion provided by the caller for comparing elements
 *  return value: the index of the last elements which is less than or euqal to 
 *  the target element, the caller determines if it is a target element 
 */ 
